...
2. `conductor/rules/CORE_RULES.md` — operational + project rules (git safety, token economy, no-inline-FQN, KI/planning discipline, Hilt, Room, Timber, build)
3. `conductor/index.md` — documentation map + project context (arch, rules, CLI)
...
- `conductor/index.md` — project architecture, rules, CLI
