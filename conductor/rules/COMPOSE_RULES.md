...
- **No hard-coded colors.** Every color reference must resolve to a `MaterialTheme.colorScheme` role. Raw `Color(0x...)` arithmetic belongs inside `BipSaleTheme` color builders, never in layout code.
