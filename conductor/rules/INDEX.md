...
| [CORE_RULES.md](CORE_RULES.md) | Standards, git safety, token economy, code style, KI discipline, regression tests, changelog, cross-project sync. **Holds the master index for the whole rule set.** | Every non-trivial change. Open the index, jump to the §N. | 21 KB |
