...
| § | Rule |
|---|---|
| **24** | [Credentials Never Enter the Repository](#24-credentials-never-enter-the-repository-global---mandatory) |

---

## 24. Credentials Never Enter the Repository (GLOBAL - MANDATORY)
...
### 24.1 What is never versioned (MANDATORY)
...
### 24.2 What the document carries instead (MANDATORY)
...
### 24.3 If a secret is already in Git (MANDATORY)
...
3. **Sanitise the files** per §24.2, saying in the document that sanitisation happened and that
...
### 24.4 Nothing here is tool-enforced today (recorded on purpose)
