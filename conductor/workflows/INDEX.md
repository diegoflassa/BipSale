...
- **[remove_filter.md](remove_filter.md)** — `/remove_filter <FILTER>`. Surgical removal of `Timber.d`/`Timber.v` calls tagged with a specific `[Filter]` token. Never touches `Timber.i/w/e`.
