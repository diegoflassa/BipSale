...
- **[remove-filter.md](remove-filter.md)** — `/remove-filter <FILTER>`. Targeted removal of `Timber.d`/`Timber.v` calls tagged with a specific `[Filter]` token. Never touches `Timber.i/w/e`.
