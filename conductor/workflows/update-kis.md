...
# /update-kis — KI Create or Update from Session Knowledge
...
Scan the session for: domain-model gaps (missing fields, wrong types), architectural decisions (layer ownership, out-of-scope calls), Room/Retrofit contract details, and "that's how it works" clarifications not yet in the KIs.
