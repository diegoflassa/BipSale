...
- **Unprotected.** This project has none by policy — a filter that exists in code but is missing from KI-04 gets catalogued, not deleted. Ticket-scoped filters (`[BipSale][BUG-123]`) are forbidden outright by `CORE_RULES.md §8.1`.
