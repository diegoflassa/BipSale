...
<!-- BipSale context — Android POS / sales app, 100% Jetpack Compose + Hilt + Room + Retrofit + Nav 3. Two-layer screens (XxxScreen / XxxScreenContent). See conductor/rules/CORE_RULES.md + INSTRUMENTED_TEST_STANDARD.md. -->
