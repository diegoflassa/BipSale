...
Full spec (source of truth) - [PLANNING_RULES.md](../../../conductor/rules/PLANNING_RULES.md) §25. Decision guide -
[KI-10](../../../conductor/knowledge/KI-10-MODEL-SELECTION.md).
...
- **Only the pool, only its configuration** (§25.6): Claude 5.0 Opus, Claude 5.0 Sonnet, Claude 5.0 Haiku,
...
- **Fallback only when it matches** (§25.4) - from a **different provider** than the recommended model, and only
