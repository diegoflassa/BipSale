...
| Shape | Mechanism |
|---|---|
| Commits an observable outcome - finalising a sale, recording a payment, moving stock, running an export | Guard held as a ViewModel property, released on the outcome |
